...
![Final learned distributions](/media/generative/ddpm_final.webp)

![DDIM](/media/generative/ddim_final.webp)

![GAN](/media/generative/gan_final.webp)

![MeanFlow](/media/generative/meanflow_final.webp)
...
![Energy distance over training](/media/generative/gan_ddpm_meanflow_energy.png)

![2-Wasserstein distance over training](/media/generative/gan_ddpm_meanflow_wasserstein.png)
...
![GAN training](/media/generative/gan_training.gif)

![DDPM training](/media/generative/ddpm_training.gif)

![MeanFlow training](/media/generative/meanflow_training.gif)
